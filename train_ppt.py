...
if __name__ == "__main__":
    ...
    args.add_argument('--device', type=str, default='cuda:0', help='The device to use for training. (cpu, mps, cuda:0, etc.)')
    args = args.parse_args()

    configs = {
        # Running env
        'global_random_seed': 42, # The global random seed for reproducibility.
        'device': 'cuda:0', # The device to use for training. (cpu, mps, cuda:0, etc.). Will be overwritten by command line argument if provided.
        ...
        'three_d': True, # Whether this is a 3D mask training.
